...
var descriptorTestTable = []descriptorTest{
	...
	},
	{
		...
		Descriptor{
			...
			Length: 16,
			Subtitling: []*DescriptorSubtitlingItem{
				{
					AncillaryPageID:   3,
					CompositionPageID: 2,
					Language:          []byte("lg1"),
	...
	},
	{
		...
		Descriptor{
			...
			Length: 10,
			Teletext: []*DescriptorTeletextItem{
				{
					Language: []byte("lg1"),
					Magazine: 2,
					Page:     12,
	...
	},
	{
		...
		Descriptor{
			...
			Length: 4,
			ParentalRating: []*DescriptorParentalRatingItem{{
	...
	},
	{
		...
		Descriptor{
			...
			Length: 5,
			VBITeletext: []*DescriptorTeletextItem{{
